...
//! Contains the basic parts for Revset evaluation and the [`Revset`] trait
//! which you need to customize for revset evaluation from the frontend.
...
/// An extension trait for the `Store` to stream commits from it.
