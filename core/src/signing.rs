...
//! Contains the `SignBackend` trait required for various signing interactions.
...
// TODO: This is a duplication of `jj_lib::store::COMMIT_CACHE_CAPACITY`. Use the respective
// constant when we lower `Store`.
