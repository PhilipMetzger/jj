...
//! Contains the [`OpStore`] trait and the related [`Operation`] and
...
/// An Opstore creates new [`Operations`] and [`Views`] which represent
/// jj-internal data at a current snapshot or time.
#[async_trait]
