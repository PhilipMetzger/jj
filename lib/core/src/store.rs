...
//! A [`Store`] provides a caching layer over a [`Backend`] and its
//! [`backend::Commit`]'s and [`backend::Tree`]'s, it also has some utility
//! functions for interacting with a [`Signer`].
